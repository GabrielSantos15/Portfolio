...
useEffect(() => {
  ...
  return (
    <header className={`site-header ${visible ? "show" : "hide"} ${menuOpen ? "open" : ""}`}>
      <figure className="logo">Logo</figure>
      
      <div className="menu">
        <nav className="nav">
          <a href="#homeSection" onClick={closeMenu}>Home</a>
          <a href="#AboutSection" onClick={closeMenu}>Sobre</a>
          <a href="#projetosSection" onClick={closeMenu}>Projetos</a>
